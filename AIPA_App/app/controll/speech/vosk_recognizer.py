...
class VoiceRecognizer:
    def __init__(self, model_path="model", sample_rate=16000, block_size=8000):
        ...
        self.start_phrases = tuple(self._normalize_text(phrase) for phrase in raw_start_phrases)
        self.stop_phrases = tuple(self._normalize_text(phrase) for phrase in raw_stop_phrases)
